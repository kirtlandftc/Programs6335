...
@Autonomous(name = "RedDouble", group = "Spooky")
public class RedProto extends OpMode {
        ...
        else
        {
            switch(stateID)
            {
                ...
                case 33: //Shoot ball
                    ...
                    break;
                case 100: //Amendment 1.0: second ball
                ...
                case 101:
                    ...
                    if(runtime.seconds() >= 24) stateID++;
                    break;
                case 102:
                    robot.catapult.setPower(1);
                    if(runtime.milliseconds() >= 26000) stateID = 34;
                    break;
